package com.demo.retail.constants;

public class Constants {

	public static final String RATE_ID="id";
	public static final String RATE_DESCRIPTION="description";
	...
	public static final String LOG_REFERENCE_ID="LOG_REF_ID";
